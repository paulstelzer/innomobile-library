    ...
    if (input) {
      switch (input) {
        case 'FREE_SUBSCRIPTION':
          return this.iapStore.FREE_SUBSCRIPTION;
        case 'PAID_SUBSCRIPTION':
          return this.iapStore.PAID_SUBSCRIPTION;
        case 'NON_RENEWING_SUBSCRIPTION':
          return this.iapStore.NON_RENEWING_SUBSCRIPTION;
        case 'CONSUMABLE':
          return this.iapStore.CONSUMABLE;
        case 'NON_CONSUMABLE':
