...
import { CordovaCheck, CordovaProperty, IonicNativePlugin, Plugin, getPromise } from '@innomobile-native/core';
...
export class File extends IonicNativePlugin {
  ...
  getFreeDiskSpace(): Promise<number> {
    return getPromise<any>((resolve, reject) => {
      (window as any).cordova.exec(resolve as (data: any) => any, reject as (data: any) => any, 'File', 'getFreeDiskSpace', []);
    });
  }
